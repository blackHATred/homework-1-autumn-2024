...
- При вводе [валидных данных](#правила-валидации) и нажатии на кнопку "продолжить" пользователь производит регистрацию  
...
- При вводе [невалидного пароля](#правила-валидации) на странице регистрации показывается сообщение о причине невалидности  
...
- При нажатии на изображение профиля открывается системное меню выбора изображения. Если пользователь выбирает [валидное изображение](#правила-валидации), то появляется зеленая галочка, аватар в хедере обновляется.  
...
- При [нарушении ограничений составления рецензии](#правила-валидации) появляется характерное сообщение об ошибке  
  <img width="551" alt="image" src="https://github.com/user-attachments/assets/52c33529-226f-474c-a4e1-d6683510a413">
- При проблемах на стороне клиента при публикации рецензии появляется характерное сообщение об ошибке  
  <img width="560" alt="image" src="https://github.com/user-attachments/assets/41712337-45bd-4c01-93d5-8bd00b58a6e3">
- При проблемах на стороне сервера при публикации рецензии появляется характерное сообщение об ошибке  
...
- [Правила валидации](#правила-валидации) для редактирования рецензии аналогичны правилам при [публикации рецензии](#написание-рецензии)
