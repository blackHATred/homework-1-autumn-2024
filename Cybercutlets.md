...
- При нажатии на поиск открывается поисковая строка с надписью "По вашему запросу ничего не найдено".  
...
- При вводе большого числа символов в поисковую строку поиск отображает ошибку пользователю с характерным сообщением:
...
> Итог: оформить репорт об органичении длины вводимой строки
...
- При поиске фильмов из "Календаря релизов"(которые еще не вышли), то их рейтинг не выводится:

![image](https://github.com/user-attachments/assets/b9e64d78-7e35-4215-b8c6-a9f1ca309082)

> Оформить репорт: Если найти фильм из раздела "Календарь релизов", то у него нет рейтинга. В разделе поиска рейтинг отображается, он равен "0.0", хотя на странице фильма из "Календаря релизов" рейтинга нет, так как фильм еще не вышел - это баг.
...
- При нажатии на избранное мы видим добавленный фильм:

![image](https://github.com/user-attachments/assets/eed4bfb4-f404-4570-8b86-b1d12b0d85fc)

- Находясь в избранном, можно удалить оттуда фильм. При этом со страницы самого фильма отметка "В избранном" пропадает.
...
- При удалении из избранного со страницы фильма, нажав на кнопку "в избранном", название кнопки обратно сменится на "добавить в избранное", со страницы фильма этот фильм также удалится.
